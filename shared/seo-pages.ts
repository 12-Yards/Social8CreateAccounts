...
export const seoLandingPages: Record<string, LandingPage> = {
  ...
  "/sports": {
    ...
    points: [
      { title: "More than match day", text: "Keep supporters and members involved between fixtures with content, groups, quizzes and competitions." },
      { title: "One club community", text: "Bring players, families, volunteers, supporters and partners into a shared digital environment." },
      { title: "Reward loyalty", text: "Recognise participation and give active members reasons to stay involved throughout the season." },
    ],
    image: "events-competitions",
  ...
  "/sports/sports-community-platform": {
    ...
    points: [
      { title: "Organise activity", text: "Manage events and competitions while giving members a clear calendar and place to participate." },
      { title: "Grow belonging", text: "Create spaces for teams, supporters, families and different interests within one club community." },
      { title: "Build a stronger club", text: "Use participation data and rewards to keep your community active beyond the field." },
    ],
    image: "events-competitions",
  ...
  "/sports/sports-fan-engagement": {
    ...
    points: [
      { title: "Create anticipation", text: "Use previews, polls and quizzes to build interest before the next fixture or event." },
      { title: "Keep the conversation going", text: "Give fans groups and content spaces that work beyond social media algorithms." },
      { title: "Make loyalty tangible", text: "Reward activity with points, gift cards, experiences and other real value." },
    ],
    image: "points-leaderboards",
  ...
  "/sports/football-community-platform": {
    ...
    points: [
      { title: "Own the relationship", text: "Create a direct channel to supporters instead of relying only on third-party social platforms." },
      { title: "Make match day interactive", text: "Add polls, quizzes, discussion and competition activity around every fixture." },
      { title: "Support the season", text: "Keep members engaged with content and rewards from pre-season to the final whistle." },
    ],
    image: "events-competitions",
  ...
  "/charities": {
    ...
    points: [
      { title: "Keep supporters close", text: "Give supporters a place to follow progress, share stories and connect with others who care." },
      { title: "Mobilise action", text: "Organise events, campaigns, petitions and activities from one community platform." },
      { title: "Show the difference", text: "Make participation visible and help members see how everyday engagement contributes to positive change." },
    ],
    image: "marketplace",
  ...
  "/charities/charity-community-platform": {
    ...
    points: [
      { title: "Create belonging", text: "Help supporters connect with one another, not just with the organisation." },
      { title: "Coordinate campaigns", text: "Give every campaign, event or fundraising initiative a clear home and audience." },
      { title: "Build lasting support", text: "Stay connected after a donation or event with useful content and ongoing participation." },
    ],
    image: "your-community",
  ...
  "/charities/charity-engagement-platform": {
    ...
    points: [
      { title: "Invite participation", text: "Ask questions, collect views and make supporters part of the conversation." },
      { title: "Reward commitment", text: "Recognise the people who consistently give their time, attention and support." },
      { title: "Extend your reach", text: "Help supporters share your work and invite others into a community they value." },
    ],
    image: "points-leaderboards",
  ...
  "/membership": {
    ...
    points: [
      { title: "Improve the member experience", text: "Give members one reliable place to find information, people and activities." },
      { title: "Increase participation", text: "Make it easy to discover events, join groups and take part in community life." },
      { title: "Strengthen retention", text: "Create ongoing value between renewals with connection, content and rewards." },
    ],
    image: "your-community",
  ...
  "/membership/membership-community-platform": {
    ...
    points: [
      { title: "Help members find their people", text: "Make it easier to connect around shared interests, location, role or activity." },
      { title: "Make activity discoverable", text: "Put every event, group and update in one place members can return to." },
      { title: "Offer more than a subscription", text: "Build a sense of belonging and participation around the membership." },
    ],
    image: "mobile-app",
  ...
  "/membership/membership-engagement": {
    ...
    points: [
      { title: "Communicate both ways", text: "Move beyond one-way email updates with posts, comments, reactions and member feedback." },
      { title: "Create regular activity", text: "Give members fresh reasons to visit through events, competitions, content and groups." },
      { title: "Recognise involvement", text: "Reward members who contribute, participate and help the community thrive." },
    ],
    image: "points-leaderboards",
  ...
  "/rewards": {
    ...
    points: [
      { title: "Earn through engagement", text: "Reward posting, commenting, attending events, entering competitions and contributing to the community." },
      { title: "Choose real value", text: "Members can select gift cards, cryptocurrency, withdrawable currency, prizes or other available rewards." },
      { title: "Create positive impact", text: "Give members the option to put their points towards tree planting and other environmentally positive actions." },
    ],
    image: "points-leaderboards",
  ...
  "/rewards/community-rewards": {
    ...
    points: [
      { title: "Set your own rules", text: "Decide which actions deserve recognition and shape rewards around your community." },
      { title: "Keep progress visible", text: "Members can see their balance, activity and position as they participate." },
      { title: "Reward beyond badges", text: "Offer tangible value that makes engagement meaningful inside and outside the platform." },
    ],
    image: "marketplace",
  ...
  "/rewards/community-gamification": {
    ...
    points: [
      { title: "Create momentum", text: "Visible progress and friendly competition give members a reason to return and contribute." },
      { title: "Reward the right actions", text: "Configure earning rules around the behaviours that make your community stronger." },
      { title: "Keep it purposeful", text: "Connect gamified activity to real rewards and positive actions, rather than empty points." },
    ],
    image: "points-leaderboards",
  ...
  "/white-label": {
    ...
    points: [
      { title: "Own the experience", text: "Create a community that reinforces your organisation instead of sending members elsewhere." },
      { title: "Scale securely", text: "Run a focused community or multiple isolated communities on shared infrastructure." },
      { title: "Extend when ready", text: "Enterprise options provide APIs, integrations and additional support as your needs grow." },
    ],
    image: "your-community",
  ...
  "/white-label/white-label-community-platform": {
    ...
    points: [
      { title: "Build trust", text: "Keep your identity present throughout the member journey, from sign-up to everyday participation." },
      { title: "Manage independently", text: "Control your content, branding, members and engagement modules without technical skills." },
      { title: "Fit your organisation", text: "Start with the core platform and extend the experience with Enterprise capabilities when required." },
    ],
    image: "your-community",
  ...
  "/white-label/white-label-community-app": {
    ...
    points: [
      { title: "Stay recognisable", text: "Keep your organisation's identity at the centre of the member experience." },
      { title: "Make participation easy", text: "Give members a convenient way to stay connected and act wherever they are." },
      { title: "Keep improving", text: "Use the wider Social8 platform to add engagement, rewards and community features over time." },
    ],
    image: "mobile-app",
